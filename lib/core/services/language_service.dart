...
class LanguageService extends ChangeNotifier {
  ...
  final Map<String, Map<String, String>> _localizedValues = {
    'ES': {
      ...
      'online_msg': 'La ruta está operando actualmente. Los tiempos mostrados se actualizan en tiempo real según la posición de la unidad.',
      ...
      'filter_all': 'TODAS',
    'operator_mode': 'MODO OPERADOR',
    'mark_arrival': 'LLEGADA A PARADA',
    'bus_full': 'BUS LLENO',
    'start_route': 'INICIAR RUTA',
    'end_route': 'FINALIZAR RUTA',
    'stop_timer_warning': 'Tiempo mínimo de espera: 5 min',
    'route_started': 'Ruta iniciada',
    'route_finished': 'Ruta finalizada',
    'stop_marked': 'Parada marcada',
    'select_route_operator': 'Seleccione ruta a operar',
    'waiting_time': 'Tiempo de espera',
      'filter_favorite': 'FAVORITAS',
      ...
      'route_operating_now': 'La ruta se encuentra operando actualmente.',
      'route_outside_habitual': 'La ruta se encuentra fuera de su horario habitual.',
      'select_this_route': 'SELECCIONAR ESTA RUTA',
      'route_label': 'RUTA',
      'matutino': 'MATUTINO',
      'vespertino': 'VESPERTINO',
      'nocturno': 'NOCTURNO',
      ...
      // Chatbot
      'bot_greeting': '¡Hola! Soy el asistente de Centro de Monitoreo.\n¿En qué te puedo ayudar hoy?',
      'bot_schedule_q': 'Dudas de Horario',
      'bot_schedule_ans': 'Para consultar los horarios de tus rutas, puedes:\n\n• Acceder al menú Horarios desde el menú lateral\n• Seleccionar tu ruta favorita y ver los tiempos estimados\n• Los horarios se actualizan en tiempo real según la posición de la unidad\n\n¿Deseas ir a la sección de Horarios ahora?',
      'bot_view_schedules': 'Ver Horarios',
      'bot_back_menu': 'Volver al menú',
      'bot_user_back_menu': 'Volver al menú',
      'bot_more_help': 'De acuerdo, ¿en qué más te puedo ayudar?',
      'bot_lost_found_q': 'Objetos Perdidos',
      'bot_lost_found_ans': 'Si perdiste un objeto en alguna de nuestras unidades, puedes reportarlo y nuestro equipo te ayudará a localizarlo.\n\n¿Deseas abrir el formulario de Objetos Perdidos?',
      'bot_report_item': 'Reportar Objeto',
      'bot_password_q': 'Cambio de Contraseña',
      'bot_password_ans': 'Para cambiar tu contraseña, te dirigimos a la sección de seguridad de tu cuenta.\n\n¿Deseas ir ahora?',
      'bot_change_pass': 'Cambiar Contraseña',
      'bot_call_support_q': 'Llamar a Soporte',
      'bot_call_support_ans': 'Te conectaremos con nuestro equipo de monitoreo para asistencia inmediata.\n\n¿Confirmas que deseas realizar la llamada?',
      'bot_call_now': 'Llamar Ahora',
      'bot_cancel_call': 'Cancelar llamada',
      'bot_understood_help': 'Entendido. ¿En qué más te puedo ayudar?',
      'bot_unit_dir_q': 'Dirección de Unidad',
      'bot_unit_dir_ans': 'La dirección y posición de las unidades se muestra en tiempo real en el mapa principal.\n\n• El ícono del bus en el mapa indica la posición actual\n• La flecha en el ícono muestra la dirección de desplazamiento\n• Puedes hacer tap en el ícono para ver más detalles de la unidad\n\n¿Necesitas algo más?',
      'bot_menu_title': 'MENÚ DE AYUDA',
      'bot_reset_chat': 'REINICIAR CHAT',
    },
    'EN': {
      // Login
      'user_label': 'USERNAME',
    ...
    'mark_arrival': 'STOP ARRIVAL',
    'bus_full': 'BUS FULL',
    'start_route': 'START ROUTE',
    'end_route': 'FINISH ROUTE',
    'stop_timer_warning': 'Minimum wait time: 5 min',
    'route_started': 'Route started',
    'route_finished': 'Route finished',
    'stop_marked': 'Stop marked',
    'select_route_operator': 'Select route to operate',
    'waiting_time': 'Waiting time',
      ...
      'route_operating_now': 'The route is currently operating.',
      'route_outside_habitual': 'The route is outside its habitual schedule.',
      'select_this_route': 'SELECT THIS ROUTE',
      'route_label': 'ROUTE',
      'matutino': 'MORNING',
      'vespertino': 'AFTERNOON',
      'nocturno': 'NIGHT',
      ...
      'salida/entrada': 'EXIT/ENTRY',
      'en_horario': 'ON SCHEDULE',
      
      // Chatbot
      'bot_greeting': 'Hello! I am the Monitoring Center assistant.\nHow can I help you today?',
      'bot_schedule_q': 'Schedule Questions',
      'bot_schedule_ans': 'To check your route schedules, you can:\n\n• Access the Schedules menu from the sidebar\n• Select your favorite route and see estimated times\n• Schedules are updated in real-time based on the unit\'s position\n\nDo you want to go to the Schedules section now?',
      'bot_view_schedules': 'View Schedules',
      'bot_back_menu': 'Back to menu',
      'bot_user_back_menu': 'Back to menu',
      'bot_more_help': 'Alright, how else can I help you?',
      'bot_lost_found_q': 'Lost & Found',
      'bot_lost_found_ans': 'If you lost an item in one of our units, you can report it and our team will help you locate it.\n\nDo you want to open the Lost & Found form?',
      'bot_report_item': 'Report Item',
      'bot_password_q': 'Password Change',
      'bot_password_ans': 'To change your password, we\'ll direct you to your account security section.\n\nDo you want to go now?',
      'bot_change_pass': 'Change Password',
      'bot_call_support_q': 'Call Support',
      'bot_call_support_ans': 'We\'ll connect you with our monitoring team for immediate assistance.\n\nConfirm you want to make the call?',
      'bot_call_now': 'Call now',
      'bot_cancel_call': 'Cancel call',
      'bot_understood_help': 'Understood. How else can I help you?',
      'bot_unit_dir_q': 'Unit Direction',
      'bot_unit_dir_ans': 'The direction and position of units is shown in real-time on the main map.\n\n• The bus icon on the map indicates the current position\n• The arrow on the icon shows the direction of travel\n• You can tap the icon for more unit details\n\nNeed anything else?',
      'bot_menu_title': 'HELP MENU',
      'bot_reset_chat': 'RESET CHAT',
    },
  };
